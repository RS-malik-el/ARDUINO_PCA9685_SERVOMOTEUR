...
void updateAngle(void); // Mets à jour le tableau int pwmValue[NB_SERVO]

void setup(){
    randomSeed(analogRead(A0)); // Initialisation des nombres pseudo-aléatoire
